...
public:
	...
	void add_constraint (const aalta_formula* c, bool ltlf = true, bool verbose = false);
...
protected:
	...
	aalta_formula* create_for_block (const aalta_formula* c, bool ltlf);
	aalta_formula* add_neg_to_var (const aalta_formula* f);
	void add_constraint_clauses (const aalta_formula* c);
